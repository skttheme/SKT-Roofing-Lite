...
<div class="container">
     <div class="copyright-txt">
        ...
        <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-roofing-company-wordpress-theme');?>" target="_blank">
        <?php esc_html_e('SKT Roofing Lite','skt-roofing-lite'); ?>
        </a>
        </div>
     <div class="clear"></div>
</div>           
